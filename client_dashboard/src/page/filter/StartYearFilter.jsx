...
import { FilterStartYear } from "../../components/Filter";
...
const StartYearFilter = () => {
  ...
  useEffect(() => {
    const results = searchFilter.filter((resp) => resp.start_year == filterInfo);
    setData(results);
  }, [filterInfo]);
  ...
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      ...
      <FilterStartYear filterValueSelected={onFilterValueSelected} />
      <GridComponent
        dataSource={data}
        width="auto"
        allowPaging
